...
<head>
	...
	<title>Profesor - Grado del estudiante</title>
        ...
        <form method="post"
            ...
            <div class="mb-3">
                <ul class="list-group">
                  ...
                  <li class="list-group-item text-center"><b>Año: </b> <?php echo $setting['current_year']; ?> &nbsp;&nbsp;&nbsp;<b>Trimestre</b> <?php echo $setting['current_semester']; ?></li>
                </ul>
            </div>
            <h5 class="text-center">Añadir grado</h5>
         ...
         <label class="form-label">Asignatura / Curso</label>
