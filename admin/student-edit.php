...
<body>
    <?php 
     ...
     <div class="container mt-5">
        <a href="student.php"
           class="btn btn-dark">Atrás</a>

        <form method="post"
              class="shadow p-3 mt-5 form-w" 
              action="req/student-edit.php">
        <h3>Editar información del estudiante</h3><hr>
        ...
        <div class="mb-3">
          <label class="form-label">Fceha de nacimiento</label>
          <input type="date" 
                 class="form-control"
        ...
        <div class="mb-3">
          <label class="form-label">Apellido del padre</label>
          <input type="text" 
                 class="form-control"
        ...
        <div class="mb-3">
          <label class="form-label">Número de teléfono del padre</label>
          <input type="text" 
                 class="form-control"
     ...
     <form method="post"
              ...
              id="change_password">
        <h3>Cambiar la contraseña</h3><hr>
       ...
       <div class="mb-3">
            <div class="mb-3">Contraseña del admin</label>
                <input type="password" 
                       class="form-control"
                       name="admin_pass"> 
          </div>
