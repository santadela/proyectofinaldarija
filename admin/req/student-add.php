...
if (isset($_SESSION['admin_id']) && 
    ...
    $em  = "Género obloigatorio";
    header("Location: ../student-add.php?error=$em&$data");
    exit;
}else if (empty($email_address)) {
    $em  = "Dirección de email es obligatoria";
    header("Location: ../student-add.php?error=$em&$data");
    exit;
    ...
    $em  = "Nombre del padre es obligatorio";
    header("Location: ../student-add.php?error=$em&$data");
    exit;
}else if (empty($parent_lname)) {
    $em  = "Apellido del padre es obligatorio";
    header("Location: ../student-add.php?error=$em&$data");
    exit;
}else if (empty($parent_phone_number)) {
    $em  = "Número de teléfono del padre es obligatorio";
    header("Location: ../student-add.php?error=$em&$data");
    exit;
}else if (empty($section)) {
    $em  = "La sección es obligatoria";
    header("Location: ../student-add.php?error=$em&$data");
    exit;
}else {
